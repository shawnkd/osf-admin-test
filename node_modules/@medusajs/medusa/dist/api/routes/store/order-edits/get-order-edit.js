...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orderEditService, id, retrieveConfig, orderEdit, _a, items, removedItems;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                orderEdit = _b.sent();
                return [4 /*yield*/, orderEditService.computeLineItems(id)];
            case 2:
                _a = _b.sent(), items = _a.items, removedItems = _a.removedItems;
