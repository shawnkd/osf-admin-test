...
exports.default = (function (app) {
    ...
    app.use("/currencies", (0, feature_flag_enabled_1.isFeatureFlagEnabled)(tax_inclusive_pricing_1.default.key), route);
    ...
    route.post("/:code", (0, middlewares_1.transformBody)(update_currency_1.AdminPostCurrenciesCurrencyReq), middlewares_1.default.wrap(require("./update-currency").default));
    return app;
});
