...
var OrderEditRepository = /** @class */ (function (_super) {
    ...
    OrderEditRepository.prototype.findWithRelations = function (relations, idsOrOptionsWithoutRelations) {
    ...
    OrderEditRepository.prototype.findOneWithRelations = function (relations, optionsWithoutRelations) {
        if (relations === void 0) { relations = []; }
    ...
    OrderEditRepository = __decorate([
        (0, typeorm_1.EntityRepository)(order_edit_1.OrderEdit)
    ], OrderEditRepository);
